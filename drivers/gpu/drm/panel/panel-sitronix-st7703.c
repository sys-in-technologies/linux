...
static int p050h031_init_sequence(struct st7703 *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETVCOM, 0xB8, 0xB8);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETPOWER_EXT, 0x26, 0x22, 0xF0,
			       0x13);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETMIPI, 0x33, 0x81, 0x05,
			       ...
			       0x00, 0x00, 0x37);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETVDC, 0x47);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_UNKNOWN_BF, 0x02, 0x10, 0x00);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETSCR, 0x73, 0x73, 0x50,
			       0x50, 0x00, 0x00, 0x12, 0x70, 0x00);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETPOWER, 0x53, 0xC0, 0x32,
			       0x32, 0x77, 0xF4, 0xDF, 0xDF, 0x7C, 0x7C,
			       0x37, 0x37);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETECO, 0x82, 0x00, 0xBF,
			       0xFF, 0x00, 0xFF);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETIO, 0xB8, 0x00, 0x0A,
			       0x00, 0x00, 0x02);

	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETCABC, 0x10, 0x40, 0x1E, 0x02);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETPANEL, 0x0B);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETGAMMA, 0x00, 0x01, 0x02,
			       0x3D, 0x3F, 0x3F, 0x2D, 0x2F, 0x04, 0x09,
			       0x0C, 0x10, 0x11, 0x0F, 0x12, 0x0F, 0x15,
			       0x00, 0x01, 0x02, 0x3D, 0x3F, 0x3F, 0x2D,
			       0x2F, 0x04, 0x09, 0x0C, 0x10, 0x11, 0x0F,
			       0x12, 0x0F, 0x15);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETEQ, 0x07, 0x07, 0x0B,
			       0x0B, 0x03, 0x0B, 0x00, 0x00, 0x00, 0x00,
			       0xFF, 0x80, 0xC0, 0x10);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETGIP1, 0xC8, 0x10, 0x09,
			       0x00, 0x00, 0x80, 0x81, 0x12, 0x31, 0x23,
			       0x37, 0x85, 0x80, 0x81, 0x37, 0x08, 0x00,
			       0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05,
			       0x00, 0x00, 0x00, 0x00, 0xF8, 0xBA, 0x46,
			       0x02, 0x08, 0x28, 0x88, 0x88, 0x88, 0x88,
			       0x88, 0xF8, 0xBA, 0x57, 0x13, 0x18, 0x38,
			       0x88, 0x88, 0x88, 0x88, 0x88, 0x00, 0x00,
			       0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, ST7703_CMD_SETGIP2, 0x96, 0x12, 0x01,
			       0x01, 0x02, 0x3C, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x8F, 0xBA, 0x31, 0x75, 0x38,
			       0x18, 0x88, 0x88, 0x88, 0x88, 0x88, 0x8F,
			       0xBA, 0x20, 0x64, 0x28, 0x08, 0x88, 0x88,
			       0x88, 0x88, 0x88, 0x23, 0x00, 0x00, 0x00,
